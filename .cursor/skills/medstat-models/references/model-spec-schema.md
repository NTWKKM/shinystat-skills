...
| `rcs_cox` | Via Python API (`fit_cox_rcs`) / CLI (`--spline-var`) | `knots: 4` or `n_knots: 4` (supplied value is used as Patsy's degrees of freedom `df`), `constraints: "center"` | Non-linearity likelihood-ratio test ($p < 0.05$) |
